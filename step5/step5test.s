...
boot:
		...
		*move.l #PUTSTRING, 0x110 /* add new level*/
...
MAIN:
		...
		*move.w #0xe108, USTCNT1 |送信割り込みまでマスク
...
LOOP:
	...
	***
		move.b #'a', %d6 /* URX1の下位8ビットのデータを転送 */
		addi.w #0x0800, %d6 /* 即値をレジスタd0に加算 */
		move.w %d6, UTX1 /* 16ビットのデータをUTX1に転送 */
	***	
		bra LOOP
