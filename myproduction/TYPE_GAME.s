...
SET_TIMER:
	move.b #'7', LED6
	move.l %d2, task_p	     /* 1.割り込みルーチンの先頭アドレスを，task_pに代入*/ 
	move.b #'0', LED0
...
TYPE_GAME_END_FLG_UP:
	move.b #0x01, (END_FLG)
	rts

TYPE_GAME_TIME_UP_FLG:
	/* 入力中止 */
	jsr TYPE_GAME_END_FLG_UP
	
	move.b #0x01, (TIME_UP_FLG)
	rts
...
TT:
	*move.b  #'4', LED4      /*文字’4’をLEDの5桁目に表示*/
	...
	cmpi.w #1, TTC				/*TTCカウンタで5回実行をカウント*/
