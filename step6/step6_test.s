...
MAIN:
		...
		*move.w #0x1000, %d0
		...
		move.w #0xe10c, USTCNT1 |送受信割り込み許可
		move.l #0x00ff3ffb,IMR  |UART1許可
...
TEST1:		
		...
		lea.l WORK,%a0		/*データ書き込み先の先頭アドレス*/

		move.l %a0,%d2		/*データ書き込み先の先頭アドレス*/
